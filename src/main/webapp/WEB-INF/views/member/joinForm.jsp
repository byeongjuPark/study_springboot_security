  ...
  <body>
     <div class="container">
      <form class="form-signin" method="post" action="/joinProc">
        <h2 class="form-signin-heading">JoinForm</h2>
        <p>
          <label for="username" class="sr-only">Username ID</label>
          <input type="text" id="username" name="username" class="form-control" placeholder="Username" required="" autofocus="" value="test-01">
        </p>
        <p>
        ...
        <p>
          ...
          <input type="phone" id="phone" name="phone" class="form-control" placeholder="phone" required="" value="test_first">
        </p>
